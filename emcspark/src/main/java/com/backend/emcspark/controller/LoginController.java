...
public class LoginController {
	...
	public @ResponseBody LoginResponse loginUser(@RequestBody User loginuser) {
		...
		try {
			...
			if (userDetails == null) {
				...
				loginResponse = new LoginResponse(userDetails);
	...
	@RequestMapping(value = "/sp/distance", method = RequestMethod.POST)
	public @ResponseBody LoginResponse distanceSearch(@RequestBody DistanceClassModel distanceClassModel) {
		...
		try {
			...
			List<DistanceClass> distanceList = loginDAO.validDistance(distanceClassModel);
			...
			if (distanceList == null) {
				...
				loginResponse = new LoginResponse(distanceList);
			    loginResponse.setStatus_code("200");
				loginResponse.setStatus_message("Successfully");
				logger.debug("User name and password  found");
				//logger.D("User name and password  found");
